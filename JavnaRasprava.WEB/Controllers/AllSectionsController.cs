...
using JavnaRasprava.WEB.Models.Landing;
using System;
...
{
	public class AllSectionsController : BaseController
	{
		[Route( "{pCode}/AllSections", Name = "def.AllSections.Index" )]
		//[Route("AllSections", Name = "leg.AllSections.Index")]
		//[Route("AllSections", Name = "sq.AllSections.Index")]
		[Route( "{pCode}/Teme", Name = "bs.AllSections.Index" )]
		[HttpGet]
